...
def get_args_parser():
    ...
    parser.add_argument("--wandb_project", type=str, default="VideoMAE SAE")
...
def train_sae(args):
    ...
    val_dataloader = _DeviceDataLoader(
        DataLoader(val_dataset, batch_size=args.batch_size, shuffle=False), args.device
    )
