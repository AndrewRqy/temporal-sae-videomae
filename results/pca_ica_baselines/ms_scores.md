...
|---|---|---|---|---|---|
| **SAE** | 6144 | **0.475 +/- 0.063** | **0.802** | 5 | cluster (results/ms_standard_deadpen.txt) |
...
PCA/ICA/raw cluster at mean ~0.467-0.469 with a tight spread and peaks ~0.50; only the
SAE has a high-MS tail (peak 0.80). Full per-feature top/bottom-10 lists are in
`ms_pca_sign_split.txt` and `ms_ica_sign_split.txt`.
