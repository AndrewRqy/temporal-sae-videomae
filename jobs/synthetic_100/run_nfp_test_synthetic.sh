#!/bin/bash
#SBATCH --job-name=nfp_synthetic
#SBATCH --output=/home/renqy/logs/nfp_synthetic_%j.out
#SBATCH --error=/home/renqy/logs/nfp_synthetic_%j.err
...
SYNTH_DIR="/net/scratch2/renqy/synthetic_acts"
...
python analysis/nfp_test_synthetic.py \
    ...
    --sae_path        "${SAE_PATH}" \
    --output_path     /net/scratch2/renqy/nfp_results/synthetic_nfp.pt \
    --device          cuda:0
