...
mkdir -p /home/renqy/logs /net/scratch/renqy/sae_checkpoints_deadpen_0p03

cd ~/sae-for-vlm

# Prerequisite: VideoMAE layer-11 activations at /net/scratch/renqy/activations/
# Run jobs/dataset/run_extract_videomae_activations.sh first.
python sae_train.py \
    --sae_model          standard \
