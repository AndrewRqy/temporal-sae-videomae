...
# Prerequisite: DINOv2 embeddings at EMBED_PATH
# Run jobs/dataset/run_ssv2_dino_embeddings.sh first.

# Extract max-pooled raw VideoMAE layer-11 activations (no SAE)
...
# Monosemanticity score on raw activations (baseline for SAE MS score)
